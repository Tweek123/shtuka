...
export default function ThreeDTour() {
  return (
    <Section className="" background="bg-[#353535]">
      <Container>
        <div className="flex flex-grow flex-col bg-[#353535] md:min-h-screen">
          <div className="mb-4 flex flex-grow flex-col items-center gap-8 text-center md:mb-16">
            <div className="flex flex-col">
              ...
              <Typography
                className="text-2.5xl font-ArialBlack font-light leading-tight text-black md:text-xl"
                variant="h2"
                fontFamily="ArialBlack"
                color="text-white"
              >
          ...
          <div className="flex flex-col md:min-h-screen">
            <iframe
              className="mb-4 aspect-square max-h-screen flex-grow md:mb-16 md:aspect-video"
              width="100%"
          ...
          <div className="flex flex-grow flex-col items-center gap-8 text-center md:mb-0">
            <div className="flex flex-col">
              <Typography
                className="font-extrabold md:text-3xl"
                variant="h1"
