      ...
      <Container className="!py-0">
        <div className="md:min-h-scree relative z-20 flex w-full flex-col pb-8 sm:pb-0 lg:px-16 lg:pb-12">
          ...
          <div className="flex flex-col lg:my-auto lg:-mr-12 lg:ml-12">
            <div className="lg:ma- z-10 mb-[120px] ml-auto flex w-[50%] flex-col gap-8 pt-8 sm:w-[55%] md:mb-8 md:ml-4 md:mr-auto md:w-[60%] lg:mx-0 lg:w-[51%] lg:gap-2 lg:px-0">
              <Typography
            ...
            <Video
              className="z-10 px-4 sm:-mx-4 sm:!aspect-[1.5/1] md:ml-4 md:w-4/6 md:px-0 lg:ml-0 lg:mr-auto lg:!aspect-[2/1] lg:w-[51%] lg:px-0"
