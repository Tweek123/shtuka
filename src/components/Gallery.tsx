...
export default function Gallery() {
  ...
  return (
    <div className="flex flex-col flex-grow">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 md:mt-12 lg:grid-cols-3 xl:grid-cols-4">
        <AnimatePresence>
            ...
            >
              <div className="relative group">
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full aspect-square object-cover grayscale hover:grayscale-0 transition-all duration-300 md:aspect-[1/1.2] lg:aspect-[1.5/1]"
                />
