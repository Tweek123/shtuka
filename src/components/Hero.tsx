          ...
          <div className="flex flex-col z-10 absolute left-0 right-0 m-auto h-full px-4 pt-24 pb-8 md:py-8 md:pt-12 text-nowrap w-fit lg:pt-20">
            <div className="flex flex-col lg:-ml-40 lg:mr-40">
              <div className="flex flex-row justify-between gap-2 mb-2 lg:justify-normal">
                ...
                <Typography
                  className="px-2 py-1 text-lg md:text-2xl xl:text-base"
                  variant="h1"
                  color="text-white"
                ...
                <Typography
                  className="px-2 py-1 text-lg font-light md:text-xl xl:text-base"
                  variant="h1"
                  color="text-[#CBCAC6]"
                  background="bg-dark-custom"
                >
              ...
              <div className="flex flex-row justify-between bg-gray-200 bg-opacity-40">
                <Divider orientation="vertical" />
                <Typography
                  className="px-1 py-1 text-[28px] text-black md:text-5xl md:py-2 lg:text-6xl lg:font-normal xl:text-7xl"
                  variant="h1"
                >
                  ДИЗАЙН ИНТЕРЬЕРА
                </Typography>
            ...
            <div className="mt-auto lg:mt-20 xl:mt-8 xl:ml-28">
              <Typography
                className="px-8 py-4 text-md mt-auto text-center md:text-5xl lg:text-2xl lg:text-left lg:font-light lg:ml-22 lg:mr-24 xl:text-3xl"
                variant="h1"
                color="text-white"
                background="bg-black"
              >
                ...
                <span className="text-xl font-light text-white md:text-2xl lg:text-2xl lg:uppercase xl:text-xl xl:text-3xl">
