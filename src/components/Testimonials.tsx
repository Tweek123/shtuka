  ...
  return (
    <Section className="!px-0">
      <Container className="!py-0">
        <div className="grid grid-cols-1 gap-8 w-full lg:grid-cols-[75%_25%] xl:grid-cols-[69.2%_30.8%] lg:gap-0">
          <Info
            className="md:text-left lg:py-0 lg:order-2 lg:text-center"
            icon={faPaintRoller}
          ...
          <Slider className="aspect-[4/5] w-full md:hidden">
            <div className="aspect-[4/5] w-full relative">
              ...
              <div className="flex flex-col text-center absolute inset-0 m-auto h-fit bg-white opacity-80 max-w-[80%] w-full p-4">
                ...
                <Divider
                  ...
                  thickness="1px"
                />
                <Typography className="text-xs" color="text-black" variant="h3">
            ...
            <div className="aspect-[4/5] w-full relative">
              ...
              <div className="flex flex-col text-center absolute inset-0 m-auto h-fit bg-white opacity-80 max-w-[80%] w-full p-4">
                ...
                />
                <Typography className="text-xs" color="text-black" variant="h3">
                  ФОТОЗОНЫ, ПОЗИТИВНЫЕ ЦВЕТА, ПЛАВНЫЕ ФОРМЫ, ДЕМОНСТРАЦИЯ ТКАНЕЙ
                  И МЕБЕЛИ
                </Typography>
              </div>
            </div>
